...
| `style`    | `"primary" \| "secondary" \| "success" \| "danger" \| "link" \| "premium"` | Style du bouton — `"secondary"` par défaut |
...
| Option    | Type                   | Description                             |
| --------- | ---------------------- | --------------------------------------- |
| `divider` | `boolean`              | Active ou non la ligne de séparation visible — transmis tel quel à Discord |
