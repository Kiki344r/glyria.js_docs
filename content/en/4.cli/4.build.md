...
After a successful build, your project will have a `dist/` folder mirroring your project structure (sources land under `dist/src/`):
...
Run `glyria build` before starting your bot in production. `glyria start` runs the compiled `dist/src/index.js` — not your TypeScript source.
::