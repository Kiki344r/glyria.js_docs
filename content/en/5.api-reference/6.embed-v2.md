...
| `style`    | `"primary" \| "secondary" \| "success" \| "danger" \| "link" \| "premium"` | Button style — defaults to `"secondary"` |
...
| Option    | Type                   | Description                 |
| --------- | ---------------------- | --------------------------- |
| `divider` | `boolean`              | Toggle the visible divider line — passed through to Discord |
